<template>
  <div class="min-h-screen font-sans text-ink selection:bg-ink selection:text-white" :class="isPublicPage ? 'bg-white block' : 'bg-paper flex'">
    ...
    <template v-else>
      <!-- Sidebar Navigation -->
      <aside class="w-64 bg-card border-r border-line flex flex-col flex-shrink-0 hidden md:flex">
      ...
      <!-- Mobile Header -->
      <div class="md:hidden fixed top-0 left-0 right-0 h-14 bg-card border-b border-line flex items-center justify-between px-4 z-50">
      ...
      <!-- Mobile Bottom Nav -->
      <div class="md:hidden fixed bottom-0 left-0 right-0 bg-card border-t border-line flex justify-around p-2 z-50 pb-safe">
